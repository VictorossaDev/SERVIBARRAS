...
namespace SERVIBARRAS.AccesoDatos.Migrations
{
    public partial class migra1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "TipoGranContribuyente",
                columns: table => new
                {
                    TipoGranContribuyenteId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NombreTipoGranContribuyente = table.Column<string>(maxLength: 400, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TipoGranContribuyente", x => x.TipoGranContribuyenteId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    VendedorId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NombreVendedor = table.Column<string>(maxLength: 400, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ClienteId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RazonSocial = table.Column<string>(maxLength: 400, nullable: false),
                    Nit = table.Column<string>(maxLength: 200, nullable: false),
